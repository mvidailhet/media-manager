...
export function useScanModuleController({
  ...
  return {
    ...
    scanModuleProps: {
      ...
      manualScanRootPath: scanRootsState.manualScanRootPath,
      missingVideos,
      onAddManualScanRoot: scanRootsState.addManualScanRoot,
      onChooseScanRootFolder: scanRootsState.chooseScanRootFolder,
      onIgnoreFailedPreview: scanIssues.ignoreFailedPreview,
      onManualScanRootPathChange: scanRootsState.setManualScanRootPath,
      onPausePreviewStripQueue: previewGeneration.pausePreviewStripQueueAction,
      onRefreshEveryScanRoot: scanRootsState.refreshEveryScanRoot,
